...
### Laboratório: SELinux SquirrelMail - Webmail

Após instalar e configurar o SquirrelMail, não é possível realizar o _login_ na interface web. O usuário recebe a mensagem de erro: Error connecting to IMAP server localhost. 13 : Permission denied
...
Edite o arquivo _/etc/selinux/config_ e configure o parâmetro

```text
SELINUX=permissive
```

Crie um arquivo no diretório root do sistema de arquivos
